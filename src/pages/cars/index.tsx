...
export function CarListPage(props: CarListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCars({
        relations: ['company', 'booking.count', 'operation.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('booking', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('operation', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'operation',
          header: 'Operation',
          accessorKey: 'operation',
          cell: ({ row: { original: record } }: any) => record?._count?.operation,
        }
      : null,
