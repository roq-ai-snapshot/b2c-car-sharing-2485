...
export function DashboardListPage(props: DashboardListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getDashboards({
        ...
        order: params.order,
        searchTermKeys: ['name.contains', 'dashboard_type.contains', 'status.contains', 'description.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'dashboard_type', header: 'Dashboard Type', accessorKey: 'dashboard_type' },
