...
import { getOperationById } from 'apiSdk/operations';
import { OperationInterface } from 'interfaces/operation';

function OperationViewPage() {
        ...
        {isLoading ? (
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              ...
              >
                <FormListItem label="Operation Type" text={data?.operation_type} />

                <FormListItem label="Operation Status" text={data?.operation_status} />
